...
const Home: NextPage<IHomeProps> = ({ jobs, projects, skills }) => {
  ...
  return (
    <div>
      <Head>
        <title>Arrarayuk 2.0</title>
        <meta
          name="keywords"
          content="miftah_alamsyah, miftah, alamsyah, miftahalamsyah, miftah rizky alamsyah, miftah rizky, rizky alamsyah, software developer, web developer"
        />
        <meta
          name="description"
          content="Hi! I am Miftah Rizky Alamsyah from Bandung, Indonesia. I am Computer Science Education Student. I am passionate about writing clean, efficient and optimized code."
        />
